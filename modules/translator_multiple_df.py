...
class Translator:
    ...
    def process_translation_lazy(self, column: str) -> pl.DataFrame:
        ...
        def translate_batch(df: pl.DataFrame) -> pl.DataFrame:
            ...
            needs_translation_mask = pl.col("comments_language_id").is_null() | \
                                     ((pl.col("comments_language_id") != pl.lit(["en"])) & \
                                      (pl.col("comments_language_id") != pl.lit(["unknown"])))
            ...
            df_no_translate = df_no_translate.with_columns([
                ...
                pl.col("comments_language_id").list.first().alias("detected_language"), # Use existing language for non-translated
...
if __name__ == "__main__":
    ...
    translator_instance = Translator(
        input_path=f"./data/src/{file}_multiple_detected.parquet",
